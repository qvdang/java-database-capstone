...
function attachHeaderButtonListeners() {
    const adminLoginButton = document.getElementById("adminLButton");
    const doctorLoginButton = document.getElementById("doctorButton");
    const patientLoginButton = document.getElementById("patientButton");

    adminLoginButton.addEventListener("click", (e) => {openModal('adminLogin');});
    doctorLoginButton.addEventListener("click", (e) => {openModal('doctorLogin');});
    patientLoginButton.addEventListener("click", (e) => {openModal('patientLogin');});
}
